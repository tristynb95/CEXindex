...
// Cell formatting, sheet building and the CSV fallback live in
// js/export-workbook.js, shared with Bakery Reports.
...
function downloadWorkbook(data) {
  ...
  EXPORT.triggerDownload(new Blob([out], { type: 'application/octet-stream' }), data.filename);
}
